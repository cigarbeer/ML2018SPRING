...
def net(input_shape, output_shape):
    ...
    model = nn_block(model, units=FULLY_CONNECTED_UNIT_NUM, n_layers=2, dropout_rate=0.25) 
...
if __name__ == '__main__': 
    ...
    model = fit_generator(model, X, y, epochs=200, batch_size=BATCH_SIZE, model_saving_path='./')
