...
if __name__ == '__main__': 
    ...
    fig, ax = plt.subplots()
    ax.scatter(comedy_2d[:, 0], comedy_2d[:, 1], label='Comedy', s=0.2)
    ax.scatter(romance_2d[:, 0], romance_2d[:, 1], label='Romance', s=0.2)
    ax.scatter(action_2d[:, 0], action_2d[:, 1], label='Action', s=0.2)
    ax.legend()
