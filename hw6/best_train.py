...
if __name__ == '__main__': 
    ...
    submodel = get_matrix_factorization_model(matrix_shape=(n_users, n_movies), latent_dimension=LATENT_DIMENSION) 
    print('[suffle index 1]')
    uid, mid, rating = read_training_data(training_data_path) 
    print('[normalize rating 1]')
    rating_normalized = normalize_rating(rating) 
